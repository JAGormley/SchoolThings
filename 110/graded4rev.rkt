...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname graded4rev) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)
...
(check-expect (place-countdown (make-countdown 500 400 10) MTS) (place-image (text "10" TEXT-SIZE TEXT-COLOR)
                                                                             ...
                                                                             MTS))
#;
(define (place-countdown c) ;stub
  MTS)

; Template from Countdown
#;
(define (place-countdown c)
  (... (countdown-x c)         
       (countdown-y c)          
       (countdown-i c)))
...
(check-expect (mouse-button empty 3 12 "button-down")
              (cons (make-countdown 3 12 10) empty))
