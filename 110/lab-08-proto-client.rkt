...
(check-expect (lot-to-image (list "2" "1"))
              (above/align "left"
                           (rectangle (- WIDTH 20)(* 2 TEXT-SIZE) "outline" "black")
                           (txt-to-image "2")
                           (above/align "left"
                                        (rectangle (- WIDTH 20)(* 2 TEXT-SIZE) "outline" "black")
                                        (txt-to-image "1")
...
(check-expect (handle-key (make-cs "Andrew" (list "r")) "e")   ;nothing happens
              (make-package (make-cs "Andrew" (list "r"))(list "twt" "e")))
